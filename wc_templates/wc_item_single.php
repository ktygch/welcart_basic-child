                                                ...
                                                <div class="tab-contents">
                                                    ...
                                                    <div data-contentid="3" class="kakusu">
                                                        ...
                                                        ?>
                                                            ...
                                                            <p class="red margin5_0 bold">SALE期間中の送料につきまして</p>
                                                            <div class="red">
                                                                SALE期間中はシステムの都合上、ご注文頂いてから、送料を再計算して<br class="hidden-xs">
                                                                ご連絡差し上げる形となります。ご不便をおかけしますが何卒ご了承下さい。（合計金額10,000円以上の送料無料に変わりはございません）
                                                            </div>
                                                        <?php else: ?>
                                                            <ul>
                                                                <li>本州、四国地方 756円</li>
                                                    ...
                                                    <div data-contentid="4" class="kakusu">
                                                        <h4>返品について</h4>
                                                        <div>
                                                            ご注文後の商品の返品・交換は受けつけておりません。但し、初期不良、発送商品間違いがあった場合に限り返品・交換をお受け致します。
                                                            その際のご連絡は、商品到着後、7日以内にEメールにてお知らせください。上記期日を過ぎた際は、返品・交換をお受けする事ができませんのでご注意下さい。
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
