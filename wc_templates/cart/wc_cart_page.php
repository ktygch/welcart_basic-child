        ...
        <div class="container padding0">
            <div class="row">
                <div class="col-sm-12 col-md-8 col-md-offset-2">
                            ...
                            <div id="cart_top">
                                ...
                                <form action="<?php usces_url('cart'); ?>" method="post" onKeyDown="if(event.keyCode == 13){return false;}">
                                    <?php if( usces_is_cart() ) : ?>
                                        <div id="cart">
                                            <div class="upbutton">
                                                <?php _e('Press the `update` button when you change the amount of items.','usces'); ?><input name="upButton" type="submit" value="<?php _e('更新','usces'); ?>" onclick="return uscesCart.upCart()" />
                                            </div>
                                                    ...
                                                    <?php if(usces_order_discount('return')): ?>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <th colspan="3" scope="row" class="aright">
                                                                <?php echo apply_filters('usces_confirm_discount_label', __('Campaign disnount', 'usces')); ?>
                                                            </th>
                                                            <th class="aright amount" style="color:#FF0000">
                                                                -<?php usces_crform(usces_order_discount('return'),true, false); ?>
                                                            </th>
                                                            <th class="stock"></th>
                                                            <th class="action"></th>
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            <th class="thumbnail"></th>
                                                            <th colspan="3" scope="row" class="aright">
                                                                <?php _e('total items','usces'); ?><?php usces_guid_tax(); ?>
                                                            </th>
                                            ...
                                            */ ?>
                                            <?php if( $usces_gp ) : ?>
                                                <div class="gp">
                                                    <img src="<?php bloginfo('template_directory'); ?>/images/gp.gif" alt="<?php _e('Business package discount','usces'); ?>" />
                                                    <span>
                                                        <?php _e('The price with this mark applys to Business pack discount.','usces'); ?>
                                                    </span>
                                                </div>
                                            <?php endif; ?>
                                        </div><!-- #cart -->
                    ...
                    <?php else: ?>
                        <p class="nothing"><?php _e('NO POSTS MATCHED YOUR CRITERIA.'); ?></p>
                    <?php endif; ?>
                </div>
            </div>
        </div>
