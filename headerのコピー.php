	...
	<div id="wrapper">
		<header id="masthead" class="" role="banner">
						...
						<ul>
							...
							<li>
								...
								<div class="mddWrap">
									<div class="mddInner">
										<ul>
											<li><a href="<?php bloginfo('url'); ?>/category/item/itemgenre/accessories/">VIEW ALL</a></li>
											<li><a href="<?php bloginfo('url'); ?>/category/item/itemgenre/accessories/?cat=30">I LOVE UGLY</a></li>
											<li><a href="<?php bloginfo('url'); ?>/category/item/itemgenre/accessories/?cat=29">by Parra</a></li>
											<li><a href="<?php bloginfo('url'); ?>/category/item/itemgenre/accessories/?cat=35">VIANEL</a></li>
										</ul>
									</div>
								</div>
                                */ ?>
							...
							<li>
								...
								<div class="mddWrap">
									<div class="mddInner">
										<ul>
											<li>
												<a href="<?php bloginfo('url'); ?>/category/item/itemgenre/homeware/">VIEW ALL</a>
											</li>
										</ul>
									</div>
								</div>
			...
			<ul class="accordion">
                ...
                <li class="i">
                    <a href="<?php bloginfo('url'); ?>/category/item/accessories/">ACCESSORIES</a>
                </li>
                <li class="i">
            ...
            <div class="menulist">
                <ul>
                    ...
                    <li>
                        <a href="#" id="topsbtn">TOPS</a>
                        <ul class="dwnlist tops">
                            <li>
                                <a href="<?php bloginfo('url'); ?>/category/item/itemgenre/tops/">VIEW ALL</a>
                            </li>
                            <li>
                    ...
                    <li>
                        <a href="<?php bloginfo('url'); ?>/category/item/itemgenre/accessories/">ACCESSORRIES</a>
                    </li>
                    <li>
                        <a href="<?php bloginfo('url'); ?>/category/item/itemgenre/homeware/">HOMEWARE</a>
                    </li>
                    ...
                    <li>
                        <a href="#" id="brandsbtn">BRANDS</a>
                        <ul class="dwnlist brands">
                            <li>
                                <a href="<?php bloginfo('url'); ?>/category/item/brand/iloveugly/">I LOVE UGLY</a>
                            </li>
                            <li>
